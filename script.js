$(function () {
    ...
    var pillar_initial_position = parseInt(pillar.css('right'));
    var pillar_initial_height = parseInt(pillar.css('height'));
    ...
    var the_game = setInterval(function () {
        ...
        if (collision(bird, pole_1) || collision(bird, pole_2) || collision(bird, pole_3) || collision(bird, pole_4) || parseInt(bird.css('top')) <= 0 || parseInt(bird.css('top')) > container_height - bird_height) {
            ...
            var pillar_current_position = parseInt(pillar.css('right'));
            ...
            if (pillar_current_position > container_width) {
            ...
            pillar.css('right', pillar_current_position + speed);
    ...
    $(document).on('keydown', function (e) {
        var key = e.keyCode;
        if (key === 38 && go_up === false && game_over === false && game_pause === false) {
